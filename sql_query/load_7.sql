-- load_7.sql
-- One-time loader for the 10_7 financial benchmark into TimescaleDB.
...
\copy base FROM '/Users/tianxin/projects/nyu/ms2/independent_study/data/financial/10_7/base.csv' WITH (FORMAT csv, HEADER true);

\copy price FROM '/Users/tianxin/projects/nyu/ms2/independent_study/data/financial/10_7/price.csv' WITH (FORMAT csv, HEADER true);

\copy split FROM '/Users/tianxin/projects/nyu/ms2/independent_study/data/financial/10_7/split.csv' WITH (FORMAT csv, HEADER true);

\copy dividend FROM '/Users/tianxin/projects/nyu/ms2/independent_study/data/financial/10_7/dividend.csv' WITH (FORMAT csv, HEADER true);
...
-- Mirrors src/test/financial/l_query/load_10_7.q.
...
INSERT INTO benchmark_params(name, value) VALUES
    ('startYear10',             DATE '2116-01-01'),
    ('endYear10',               DATE '2116-01-01' + 3650),
    ('startYear10Plus2',        DATE '2116-01-01' + 730),

    ('start300Days',            DATE '2125-01-01'),
    ('end300Days',              DATE '2125-01-01' + 300),

    ('startPeriod',             DATE '2126-01-01'),
    ('endPeriod',               DATE '2126-02-05'),

    ('start6Mo',                DATE '2125-08-01'),
    ('end6Mo',                  DATE '2125-08-01' + 186),

    ('maxTradeDateMinus3Years', DATE '2125-01-01');
